document.addEventListener('DOMContentLoaded', () => {
    ...
    const fetchPokemon = async(identificadorPokemon) => {
        ...
        try {
            ...
            if(!response.ok){
                throw new Error('404 NOT FOUND - Pokémon não encontrado!');
            }
    ...
    fetchPokemon(idAtualPokemon); //carregando o primeiro pokemon de Id = 1 por padrão
    atualizarBotaoPesquisar(); //desabilita o botao de busca inicialmente
